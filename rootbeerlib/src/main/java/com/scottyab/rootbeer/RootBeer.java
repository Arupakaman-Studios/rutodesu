...
public class RootBeer {
    ...
    public boolean isRooted() {
        ...
        return hasRootManagementApps() || hasPotentiallyDangerousApps() || checkForSuBinary()
    ...
    public boolean isRootedWithBusyBoxCheck() {
        ...
        return hasRootManagementApps() || hasPotentiallyDangerousApps() || checkForSuBinary()
                || checkForBusyBoxBinary() || checkForDangerousProps() || checkForRWPaths()
                || detectTestKeys() || checkSuExists() || checkForRootNative() || checkForMagiskBinary();
    }
     ...
     */
    public List<String> detectRootManagementApps() {
        return detectRootManagementApps(null);
    }

    public boolean hasRootManagementApps() {
        return hasRootManagementApps(null);
    }
     ...
     * @return true if one of the apps it's installed
     */
    public boolean hasRootManagementApps(String[] additionalRootManagementApps) {
        return !detectRootManagementApps(additionalRootManagementApps).isEmpty();
    }

    public List<String> detectRootManagementApps(String[] additionalRootManagementApps) {
        ...
        return packageFromListInstalled(packages);
    }
    ...
    public boolean hasPotentiallyDangerousApps() {
        return hasPotentiallyDangerousApps(null);
    }
     ...
     * @return true if one of the apps it's installed
     */
    public boolean hasPotentiallyDangerousApps(String[] additionalDangerousApps) {
        return !detectPotentiallyDangerousApps(additionalDangerousApps).isEmpty();
    }

    public List<String> detectPotentiallyDangerousApps(String[] additionalDangerousApps) {
    ...
    public boolean hasRootCloakingApps() {
        return hasRootCloakingApps(null) || canLoadNativeLibrary() && !checkForNativeLibraryReadAccess();
    }
    ...
    public boolean hasRootCloakingApps(String[] additionalRootCloakingApps) {
        return !detectRootCloakingApps(additionalRootCloakingApps).isEmpty();
    }

    public List<String> detectRootCloakingApps(String[] additionalRootCloakingApps) {
    ...
    public boolean checkForSuBinary(){
        return !TextUtils.isEmpty(pathSuBinary());
    }

    public String pathSuBinary(){
     ...
     * @return true if found
     */
    public boolean checkForMagiskBinary(){ return !TextUtils.isEmpty(pathMagiskBinary()); }

    public String pathMagiskBinary(){ return checkForBinary("magisk"); }
    ...
    public boolean checkForBusyBoxBinary(){
        return !TextUtils.isEmpty(pathBusyBoxBinary());
    }

    public String pathBusyBoxBinary(){
     ...
     * @return true if found
     */
    public String checkForBinary(String filename) {
     ...
     */
    private List<String> packageFromListInstalled(List<String> packages){
